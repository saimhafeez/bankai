...
class CreditCardWidget extends StatefulWidget {
  ...
  const CreditCardWidget({
    ...
    super.key,
    // Custom
    this.labelValidFrom = "VALID\nFROM",
    required this.issueDate,
    required this.cardTypeText,
  });

  /// Custom
  final String labelValidFrom;
...
class _CreditCardWidgetState extends State<CreditCardWidget>
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  widget.cardTypeText.toUpperCase(),
                  maxLines: 1,
                  ...
                  child: Expanded(
                    child: Text(
                      widget.cardHolderName.isEmpty
                          ...
                          : widget.cardHolderName.toTitleCase(),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: widget.textStyle ?? defaultTextStyle,
                    ),
  ...
  Widget _getCardTypeIcon() {
    final CardType ccType = widget.bankName?.toLowerCase() == "bankai" ? CardType.bankai : widget.cardType ?? detectCCType(widget.cardNumber);
